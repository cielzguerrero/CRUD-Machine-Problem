...
include '../assets/studentauth.php';
$currentstudent = $result->fullname;
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="container-fluid">
                ...
                <div class="dashboard-content">
                    <div class="row ">
                        <div class="col align-middle">
                            <div class="card">
                                ...
                                <div class="card-footer d-flex justify-content-around">
                                    <div>
                                        <small class="align-middle mr-3">Welcome, <?= $result->fullname ?></small>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col align-middle">
                            <div class="card">
                                ...
                                <div class="card-footer d-flex justify-content-around">
                                    <div>
                                        <small class="align-middle mr-3">Respect your teachers!</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <table id="daTable" class="table table-bordered">
                                ...
                                <tbody>
                                    <?php
                                    $query = "SELECT * FROM grades WHERE studentname = '$currentstudent'";
